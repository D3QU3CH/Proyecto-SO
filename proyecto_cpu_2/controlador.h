...
/* =====================================================================
 * controlador.h  –  Logica de negocio del simulador
 *
 * Contiene TODO lo que "hace cosas" con los datos:
 *   - Algoritmos de planificacion   (FCFS, Round Robin)
 *   - Procesamiento de E/S
 *   - Control automatico de algoritmo (decidirCambio)
 *   - Apropiatividad                (seleccionarProcesoCritico, moverAlFrente)
 *   - Ajuste de quantum             (evaluarColas)
 *   - Manejo de teclado             (manejarEntrada)
 *   - Persistencia / logs           (guardarTablaProcesos, etc.)
 * ===================================================================== */
...
/* Procesa un ciclo en todas las colas de E/S;
   devuelve los listos a colaListos                         */
...
/* Muestra los 5 procesos con mas ciclos pendientes y pide al
   usuario elegir uno; lo marca como apropiativo.            */
...
/* Detecta teclas sin bloquear y ejecuta la accion correspondiente:
   X=cambiar algoritmo  A=apropiatividad(RR)  M=memoria  S=estado  */
